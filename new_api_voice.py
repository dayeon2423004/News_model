# voice
# Api key
# 실행 command : uvicorn api_voice:app --reload
...
MODEL_DIR1 = "fine_tuned_model"
MODEL_DIR2 = "finetuned-koelectra"

model1 = MT5ForConditionalGeneration.from_pretrained(MODEL_DIR1)
tokenizer1 = T5Tokenizer.from_pretrained(MODEL_DIR1)
